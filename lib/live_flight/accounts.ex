defmodule LiveFlight.Accounts do
  @moduledoc """
  The Accounts context.
  """

  import Ecto.Query, warn: false
  alias LiveFlight.Repo

  alias LiveFlight.Accounts.{User, UserToken, UserNotifier}
  ...
  See `LiveFlight.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `LiveFlight.Accounts.User.password_changeset/3` for a list of supported options.
