defmodule LiveFlight.Blog do
  ...
  def subscribe_posts(%Scope{} = scope) do
    ...
    Phoenix.PubSub.subscribe(LiveFlight.PubSub, "user:#{key}:posts")
  end

  defp broadcast(%Scope{} = scope, message) do
    key = scope.user.id

    Phoenix.PubSub.broadcast(LiveFlight.PubSub, "user:#{key}:posts", message)
  end
