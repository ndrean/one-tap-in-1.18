...
#
#     PHX_SERVER=true bin/live_flight start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :live_flight, LiveFlightWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :live_flight, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :live_flight, LiveFlight.Mailer,
